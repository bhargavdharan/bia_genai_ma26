...
lazy_agent = AssistantAgent(
    ...
    system_message='Give the answer of question asked with the information you have or are provided by the user as part of the feedback recieved. Check the chat history for the previous conversation and mostly you will have the information required. ' \
    'If you still do not have the information for the task, just say "TERMINATE"'
)
